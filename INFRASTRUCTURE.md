...
|---|---|---|
| `auto_news.yml` | Сбор мировых новостей → перевод → статьи на сайте + sitemap | 07:00 и 17:00 UTC (10:00 и 20:00 МСК) |
| `daily_post.yml` | Публикация постов в Telegram-канал | 03:00, 09:00, 15:00 и 20:30 МСК |

...
- **Согласие на подписку:** в форме подписки обязательный чекбокс согласия на обработку e-mail (проверка в `initSubscribe()` в script.js). Без отметки — подписка блокируется.

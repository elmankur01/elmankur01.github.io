...
auto-parts/
  ...
  article_images.js      — IMAGES (url/alt/credit всех фото статей); грузится и на главной (превью в карточках), и в Node (generate_articles.js через article_content.js)

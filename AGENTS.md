...
auto-parts/
  ...
  styles.css    — все стили (1362+ строк)
  script.js     — логика каталога, чата, партнёрской секции, модалок, UX-улучшения
  data.js       — база деталей (597+ шт, 16 категорий), конфиг магазинов, функции трекинга
  admin.html    — админ-панель (CRUD каталога, магазины, статистика, экспорт data.js)

...
Автопостинг работает сам: `daily_post.yml` публикует статью 4 раза в день (00, 06, 12, 18 UTC), `daily_world_post.yml` — рубрику «Мировые новости» в 07:00, `daily_market_post.yml` — «Новости рынка» в 08:00.
